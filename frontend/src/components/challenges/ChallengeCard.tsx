...
export default function ChallengeCard({ id, title, daysLeft, stake, progress, participants }: ChallengeCardProps) {
  ...
  return (
    <Link href={`/challenges/${id}`}>
      <div className="relative bg-blueprint-bg border-1 border-blueprint-line rounded-xl p-6 hover:shadow-md transition-all duration-300 cursor-pointer">
